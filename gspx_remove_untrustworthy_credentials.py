#!/usr/bin/env python3
"""
GSP-X trust-aware variant: CREDENTIAL-LEVEL filtering (Sec. IV-A).
...
CRED_TRUST_THRESHOLD = 0.5
NOISE_TRUST_HIGH = 0.49
TRUST_SEED = 4
VARIANT_DIR = "GSP-X_remove_untrustworthy_credentials"
...
def main() -> None:
    ...
    # Credential-level filtering: drop low-trust credentials from records.
